#include "client/renderer/vulkan_image.hpp"
...
{
	auto out = std::make_unique<VulkanImage>();
...
bool VulkanImage::transition_layout(const CommandBuffer* cb, vk::ImageLayout old_layout, vk::ImageLayout new_layout)
{
...
void VulkanImage::copy_from_buffer(const CommandBuffer* cb, vk::Buffer buffer)
{
